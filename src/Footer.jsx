        ...
        <div>
            <footer className='w-full h-auto bg-gray-100 max-sm:h-auto'>
                ...
                <div className='flex  justify-evenly'>
                    <div className='flex  w-50 ms-15 max-sm:ms-0 max-lg:ms-0  max-sm:w-40 '>
                        <img className='w-10 h-15 m-[0px_20px_0px_20px] max-sm:w-[20px] max-sm:h-[25px]' src={Place} alt="place" />
                        <p className='w-50 h-40  font-[Be-Vietnam] font-normal text-2xl max-lg:w-[189px] max-lg:h-[135px]  max-lg:font-bold  max-lg:text-[18px]  max-sm:w-[86px] max-sm:h-[57.04px] max-sm:text-[8px] max-sm:font-bold'>
                            123, Raja Street,
                            Kumbakonam,
                            Thanjavur District,
                            Tamil Nadu, 612001.
                    ...
                    <div className='me-1 border shadow-[0px_5px_5px] h-[200px] max-lg:h-[180px] border-black  border-solid  shadow-gray-400 max-sm:h-[58.95px]'></div>
                    <div className=' border shadow-[0px_5px_5px]  h-[200px]  max-lg:h-[180px] border-black  border-solid shadow-gray-400 max-sm:h-[58.95px]'></div>
